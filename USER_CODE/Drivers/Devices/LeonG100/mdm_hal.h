...
public:
    ...
    */
    bool connect(const char* simpin = NULL,
            const char* apn = "v-internet", const char* username = NULL,
    ...
    */
    bool registerNet(NetStatus* status = NULL, uint32_t timeout_ms = 300000);
    ...
    */
    bool pdp(const char* apn = "v-internet");
    ...
    */
    MDM_IP join(const char* apn = "v-internet", const char* username = NULL,
                       const char* password = NULL, Auth auth = AUTH_DETECT);
    ...
    */
    bool socketSetBlocking(int socket, uint32_t timeout_ms);
...
*/
class MDM_DeviceSerial : public SerialPipe, public MDMParser
{
public:
    /** Constructor
    ...
    */
    MDM_DeviceSerial( int rxSize = 256); //Size Pipe buffer for Modem
    //! Destructor
    virtual ~MDM_DeviceSerial(void);
...
extern MDM_DeviceSerial thanhntMDM;
